    ...
    <div class="col-md-10 col-md-offset-1 dashboard-center">
        <nav class="navbar navbar-inverse" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse-01">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url() . 'admin/permissions'; ?>">Permissions</a></li>
                </ul>
        ...
        <div>
            ...
            <ul class="nav nav-tabs">
                ...
                <li id="table5"><a onclick="showtable3('boardtable','table6');">Boards</a></li>
            ...
            <div id="boardtable" style="display:none">
                ...
                <form role="form" method="post" action="<?php echo base_url('adminaction/addBoard'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="description" required style="width:300px">
                    </div>
                    <div class="form-group">
                ...
                <table class="table table-condensed">
                    ...
                    <?php foreach ($tags as $tag): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('adminaction/deletetag/' . $tag->id); ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
